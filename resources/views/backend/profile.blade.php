                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="info">
                            ...
                            <form class="form-horizontal" action="{{ route('user.profile.update') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="username" disabled class="form-control" id="username" placeholder="Username" value="{{ old('username') ?? Auth::user()->username }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="title" class="form-control" id="title" placeholder="Title" value="{{ old('title') ?? Auth::user()->title }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="about" class="form-control" id="about" placeholder="About">{{ old('about') ?? Auth::user()->about }}</textarea>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane" id="avatar">
                            <form action="{{ route('user.profile.image.update') }}" method="POST"
                                ...
                                @csrf
                                @method("PUT")
                                <input type="file" name="image" data-max-height="5000" class="dropify" data-max-file-size="3mb"
