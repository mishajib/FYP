                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-dark btn-sm"
                               href="{{ route('user.tags.show', $tag->slug) }}">
                                <i class="fas fa-eye"></i>
                            </a>

                            @can('edit tag')
                                @if($tag->is_default == false)
                                    <a class="btn btn-info btn-sm"
                                       href="{{ route('user.tags.edit', $tag->slug) }}">
                                ...
                                @if($tag->is_default == false)
                                    <button onclick="deleteItem({{ $tag->id }})"
                                        ...
                                        <form id="delete-form-{{ $tag->id }}"
                                              action="{{ route('user.tags.destroy', $tag->id) }}"
                                              method="POST">
                                            @csrf
                                            @method('DELETE')
                                        </form>
