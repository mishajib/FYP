        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('user.categories.update', $category->id) }}" method="POST">
                        @csrf
                        @method("PUT")
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" data-placeholder="Select parent category"
                                        class="form-control select2bs4" id="select" style="width: 100%;">
                                    <option value=""></option>
                        ...
                        <div class="card-footer">
                            <a class="btn btn-dark" href="{{ route('user.categories.index') }}">Cancel</a>
