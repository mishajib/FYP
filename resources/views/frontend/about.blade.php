                ...
                <div class="col-md-4">
                    ...
                    <div class="aside-widget">
                        ...
                        <div class="post post-widget">
                            <a class="post-img" href="#"><img src="{{ asset('assets/frontend/img/widget-1.jpg') }}" alt=""></a>
                            <div class="post-body">
                        ...
                        <div class="post post-widget">
                            <a class="post-img" href="#"><img src="{{ asset('assets/frontend/img/widget-2.jpg') }}" alt=""></a>
                            <div class="post-body">
                        ...
                        <div class="post post-widget">
                            <a class="post-img" href="#"><img src="{{ asset('assets/frontend/img/widget-3.jpg') }}" alt=""></a>
                            <div class="post-body">
                        ...
                        <div class="post post-widget">
                            <a class="post-img" href="#"><img src="{{ asset('assets/frontend/img/widget-4.jpg') }}" alt=""></a>
                            <div class="post-body">
                                <h3 class="post-title"><a href="#">Tell-A-Tool: Guide To Web Design And Development Tools</a></h3>
                            </div>
                        </div>
