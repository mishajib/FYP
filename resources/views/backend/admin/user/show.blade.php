        ...
        <div class="col-md-6 mx-auto">
                ...
                <div class="card-body box-profile">
                    ...
                    @else
                        <p class="text-muted text-center"><span
                                class="text-danger">Not found!!!</span></p>
                    @endif

                    <ul class="list-group list-group-unbordered mb-3 text-center">
                        <li class="list-group-item">
                            <b>Username:</b> <span
                                class="ml-3">{{ $user->username }}</span>
                        </li>

                        <li class="list-group-item">
                            <b>Email:</b> <span
                                class="ml-3">{{ $user->email }}</span>
                        </li>

                        <li class="list-group-item">
                            <b>Phone Number:</b> <span
                                class="ml-3">{{ $user->phone_number }}</span>
                        </li>

                        <li class="list-group-item">
                            <b>IP Address:</b> <span
                                class="ml-3">{{ $user->client_ip }}</span>
                        </li>

                        <li class="list-group-item">
                            <b>Machine Name:</b> <span
                                class="ml-3">{{ $user->machine_name }}</span>
                        </li>
                    ...
                    <p class="text-center">
                        <a href="{{ route('admin.user.index') }}"
                           class="btn btn-secondary"><b>Back</b></a>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    @else
                        <p class="text-muted"><span class="text-danger">Not found!!!</span>
                        </p>
                    @endif
                        ...
                        @empty
                            <tr>
                                <td class="text-center" colspan="9">
                                    <span
                                        class="text-danger h3">No data found!</span>
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
